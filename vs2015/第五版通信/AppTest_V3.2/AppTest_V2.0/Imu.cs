...
namespace AppTest_V2._0
{
    public partial class Imu : UserControl
    {
        ...
        public void chuanzhi(float[] x)
        {
            ...
            textBox13.Text = x[1].ToString();
            textBox11.Text = x[0].ToString();
            textBox12.Text = x[2].ToString();//横滚，俯仰，偏航

            textBox4.Text = x[3].ToString();
            textBox5.Text = x[4].ToString();
            textBox6.Text = x[5].ToString();//加速度

            textBox1.Text = x[6].ToString();
            textBox2.Text = x[7].ToString();
            textBox3.Text = x[8].ToString();//角速度

            textBox7.Text = x[9].ToString();
            textBox8.Text = x[10].ToString();
            textBox9.Text = x[11].ToString();//磁力计
        }
