...
#define ACC_2G_SCALE   (65536/2)/2
#define ACC_4G_SCALE   (65536/2)/4
#define ACC_8G_SCALE   (65536/2)/8
#define ACC_16G_SCALE   (65536/2)/16

#define Gyro_250An_SCALE (1/(65536/2))*250
#define Gyro_500An_SCALE (1/(65536/2))*500
#define Gyro_1000An_SCALE (1/(65536/2))*1000
#define Gyro_2000An_SCALE (1/(65536/2))*2000
//#define Gyro_2000An_SCALE (1/65535) * 4000* 0.0174532925f
//=======================================================================================================MPU6050
...
protected:
	...
	//Sensor Origin data
	u8 _Sensor_data[15];
	int16_t ACC_Origin_Move[3][MOV_AVERAGE_MAX_COUNT];
	int16_t ACC_Origin_LPF[3];
	
public:
	bool Is_Success;
	int Initial_success;
	MPU6050(I2C &i2c,bool _Zero_Calibrate=true,bool _EN_LPF=false,bool _EN_Move=false);
	virtual bool Initialize_IMU(void);
	virtual bool Update_data(Vector3f &Acc,Vector3f &Gyro);

private:
	bool EN_Filter_LPF;
	bool EN_Filter_AntiPulseMoveAverage;
	LPF<int16_t> Acc_LPF[3];
	MoveAverageFilter<int16_t> Acc_Mov[3];

	//Wait Gyro to Calm When Imu Initialized
	bool WaitForCalm(void);
